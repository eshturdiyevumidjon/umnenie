...
<div class="header about-header">
        ...
        <h4 class="header-text">Вакансии</h4>
    ...
    <div class="accordion">
        ...
        <ul>
          <li> 
            ...
            <div class="msg">
                <?=$model->text?>
                <form class="form" action="send-jobs" method="get">
                    <input type="hidden" value="<?php echo $model->id ?>" name="vacancy_id">
                    <fieldset class="form-field form-field-1">
                        <label class="form-label" for=""></label>
                        <input class="form-input form-input-1" id="fio" name="fio" type="name" required="" placeholder="Ф.И.О"/>
                    </fieldset>
                    <fieldset class="form-field form-field-2">
                        <label class="form-label" for=""></label>
                        <input class="form-input form-input-2" id="email" name="email" type="email" required="" placeholder="Email"/>
                    </fieldset>
                    <fieldset class="form-field form-field-1-3">
                        <label class="form-label" for=""></label>
                        <input class="form-input form-input-3" id="name" name="name" type="text" required="" placeholder="Название компании"/>
                    </fieldset>
