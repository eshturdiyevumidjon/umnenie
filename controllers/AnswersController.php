...
class AnswersController extends Controller
{
    ...
    //return  file_get_contents("https://stackoverflow.com/");
//mail('dasturchiuz@gmail.com', 'Test Email', 'Test Message body');

        $email = "eshturdiyevumidjon@gmail.com";
                Yii::$app
                    ->mailer
                    ->compose()
                    ->setFrom(['itake1110@gmail.com' => 'Biznes Rivoj'])
                    ->setTo($email)
                    ->setSubject('Рассылка')
                    ->setHtmlBody("test")
                    ->send();
    ...
    /**
     * Delete an existing Answers model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Answers model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
